...
const lightModeStyles = {
  ...
  backgroundColor:
    "linear-gradient(90deg, rgba(245, 243, 243, 1) 0%, rgba(247, 247, 247, 1) 100%)", // Light gradient
...
const Go = FaLocationArrow as unknown as React.FC<
...
const Project = () => {
  ...
  // Start showing 2 projects (from the bottom)
  const [projectLimit, setProjectLimit] = useState(2);

  // const handleShowMore = useCallback(() => {
  //   setProjectLimit((prev) => Math.min(prev + 4, totalProjects));
  // },[projectLimit])
  ...
  // Slice from bottom to top
  // const visibleProjects =useMemo(()=> ProjectData.slice(totalProjects - projectLimit),[projectLimit])
  const visibleProjects = ProjectData.slice(totalProjects - projectLimit)
  return (
                  ...
                  <div className="w-full h-full flex flex-col p-4 gap-5">
                    ...
                    <div className="flex items-center justify-between mt-7 mb-3">
                      ...
                      <div className="flex justify-center items-center">
                        ...
                        <Go className="ms-3" color="#CBACF9" />
                      </div>
                    </div>
                  </div>
                </a>
